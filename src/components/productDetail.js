    ...
    import { Box, Stack, HStack, Heading, VStack, Image, Button, Spacer } from "@chakra-ui/react";
    ...
    const ProductDetail = () => {
        ...
        return (
            <Box mt={150} mb={75} w='60%' alignSelf={'center'}>
                <Stack className="pd-layout" direction="row" alignItems={'initial'}>
                    <Image 
                        className="pd-image"
                    ...
                    />
                    <VStack className="pd-info" h="auto" align="start" gap={1}>
